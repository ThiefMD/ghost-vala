This is a Vala based repository for interacting with a Ghost blog rest API. We aim for a casual laid back atmosphere, but deliver serious and reliable code.
...
## Repository Structure
  ...
  * `src/`: Contains the source code for the application.
    * Ghost.vala: Compiles for libsoup2.4
    * Ghost3.vala: Compiles for libsoup3
